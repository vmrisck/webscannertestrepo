            ...
            for (const item of repoStats.split('\n')) {
                ...
                scanResults.recentRepos.forEach(recent => {
                    ...
                    if (recent.repoPiiCount != 0 )
                        recentRow += `<div class="table-body-cell"><img title="${recent.repoPiiCount}" src="img/check-circle.svg" alt="${recent.repoPiiCount}" class="piiFound"/></div>`
                    else
                    ...
                    if (recent.repoApiCallsCount != 0)
                        recentRow += `<div class="table-body-cell"><img title="${recent.repoApiCallsCount}" src="img/check-circle.svg" alt="${recent.repoApiCallsCount}" class="piiFound"/></div>`
                    else
