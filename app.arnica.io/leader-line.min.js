    ...
    he =
      ...
      function (e) {
        return (
          ...
          (!(e = Object.getPrototypeOf(e)) || ((e = e.hasOwnProperty("constructor") && e.constructor) && "function" == typeof e && c.call(e) === d))
        );
      }),
    pe =
      Number.isFinite ||
          ...
          i.prototype = {
            ...
            _parseNumber: function () {
              ...
              if (
                ...
                this._currentIndex === this._endIndex ||
                  ((this._string[this._currentIndex] < "0" || "9" < this._string[this._currentIndex]) && "." !== this._string[this._currentIndex]))
              )
                return null;
                ...
                e = r(
                  ...
                  t.forEach(function (e) {
                    ...
                    "M" === r
                      ...
                      ? ((o = e.values[5]),
                        (l = e.values[6]),
                        s.push({ type: "A", values: [e.values[0], e.values[1], e.values[2], e.values[3], e.values[4], o, l] }),
                        (u = o),
                        (h = l))
                      : "a" === r
                      ? ((o = u + e.values[5]),
      ...
      f.position_path !== y.position_path ||
        ...
        [0, 1].some(function (e) {
          return (
            ...
            (e = null == t ? "auto" : Array.isArray(t) ? "array" : "number") != (null == n ? "auto" : Array.isArray(n) ? "array" : "number") ||
            ...
            for (
              ...
              (function () {
                ...
                if (o[0] === o[1]) {
                  ...
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      ...
                      (u[t.notContain] = c(
                        u[t.notContain],
                        ee,
                        f(u[t.contain], u[t.notContain]) ? ("x" === o[t.notContain] ? r : l) : S(u[t.notContain], u[t.contain], "x" === o[t.notContain] ? "y" : "x")
                      )))
                  ...
                  if (n[0] && n[1])
                    return void (f(u[1], u[0]) ? s[1].push(u[1]) : f(u[0], u[1]) ? s[0].push(u[0]) : s[0].push("x" === o[0] ? { x: u[1].x, y: u[0].y } : { x: u[0].x, y: u[1].y }));
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      s[t.notContain].push(u[t.notContain]),
                      (u[t.notContain] = c(
                        u[t.notContain],
                        ee,
                        m(u[t.notContain], u[t.contain], o[t.contain]) >= ee ? S(u[t.notContain], u[t.contain], o[t.contain]) : u[t.contain].dirId
                      )))
                    : ((i = [
                        { x: u[0].x, y: u[0].y },
                        { x: u[1].x, y: u[1].y }
          ...
          0 < e
            ? 2 === (n = _[(a = p ? 0 : _.length - 1)]).length
              ? ((d[a] = d[a] || Ae.apply(null, n)),
                d[a] > $ && (d[a] - e < $ && (e = d[a] - $), (s = Ve(n[0], n[1], (p ? e : d[a] - e) / d[a])), (_[a] = p ? [s, n[1]] : [n[0], s]), (d[a] -= e)))
              ...
              Xe(m, _.plug_enabledSE, n, (S = g.plug_enabledSE[n]), v.apl_plug_enabledSE) &&
                ...
                g.plug_enabledSE[n] &&
                  ...
                  g.plugOutline_enabledSE[n] &&
                    ...
                    Xe(m, _.plugOutline_strokeWidthSE, n, (S = g.plugOutline_strokeWidthSE[n]), v.apl_plugOutline_strokeWidthSE) &&
                      ((m.plugOutlineMaskShapeSE[n].style.strokeWidth = S + "px"), (E = !0)),
                    Xe(m, _.plugOutline_inStrokeWidthSE, n, (S = g.plugOutline_inStrokeWidthSE[n]), v.apl_plugOutline_inStrokeWidthSE) &&
      ...
      (U.mask =
        ...
        R.lineMask_enabled &&
          ...
          Xe(W, F, "caps_enabled", (B = R.caps_enabled)) &&
            ((W.lineMaskCaps.style.display = W.lineOutlineMaskCaps.style.display = B ? "inline" : "none"), (G = !0), re && je(W, W.capsMaskLine)),
          R.caps_enabled &&
            ([0, 1].forEach(function (e) {
              var t;
      ...
      return (
        null != t[n] &&
          ((l.acceptsAuto && (t[n] + "").toLowerCase() === D) ||
            ((p = h = t[n]), ("number" === (c = a) ? pe(p) : typeof p === c) && ((h = s && "string" === a && h ? h.trim() : h), 1) && (!r || r(h)))) &&
          h !== l.container[l.key] &&
          ...
          [0, 1].forEach(function (e) {
            ...
            [0, 1].forEach(function (t) {
              ...
              Xe(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                (re
                  ? ((n = Oe(n)), (a.efc_gradient_stopSE[t].style.stopColor = n[1]), (a.efc_gradient_stopSE[t].style.stopOpacity = n[0]))
                ...
                if (0 === e) n = [[o[0][0], o[0][0]]];
                  ...
                  t &&
                    (2 === (a = o[i]).length
                      ...
                      : ((e = Ne(a[0], a[1], a[2], a[3], We(a[0], a[1], a[2], a[3], t))), n.push([a[0], e.fromP1, e.fromP2, e])));
                }
                return n;
              },
              function (e, t) {
            ...
            "circle" === e.shape
              ...
              : "polygon" === e.shape &&
                ...
                e.points.every(function (e) {
                  var t = {};
                  return (
                    !(!(t.x = O.pointAnchor.parsePercent(e[0], !0)) || !(t.y = O.pointAnchor.parsePercent(e[1], !0))) && (n.push(t), (t.x[1] || t.y[1]) && (a.hasRatio = !0), !0)
                  );
                })
            ...
            switch (t.shape) {
              ...
              case "polygon":
                t.points.forEach(function (e) {
                  ...
                  i
                    ? (t < i.left && (i.left = t), t > i.right && (i.right = t), e < i.top && (i.top = e), e > i.bottom && (i.bottom = e))
      ...
      mouseHoverAnchor: {
        ...
        init: function (a, i) {
          var n,
            ...
            c = {};
          if (
            ((a.element = O.pointAnchor.checkElement(i.element)), (s = a.element), !((u = s.ownerDocument) && (h = u.defaultView) && h.HTMLElement && s instanceof h.HTMLElement))
          )
      ...
      captionLabel: {
        ...
        unbind: function (e, t) {
          ...
          e.elmsAppend &&
            ...
            e.refSocketXY
              ? (De(n, "apl_position", e.updateSocketXY), e.offset || (De(n, "cur_attach_plugSideLenSE", e.updateSocketXY), De(n, "cur_line_strokeWidth", e.updateSocketXY)))
              ...
              (l.updateStartOffset = function (e) {
                ...
                n.pathData &&
                  ((2 === l.semIndex && !l.lineOffset) ||
                    ...
                    2 !== l.semIndex &&
                      ((o = Math.max(o.attach_plugBackLenSE[l.semIndex] || 0, o.line_strokeWidth / 2) + l.strokeWidth / 2 + l.height / 4),
